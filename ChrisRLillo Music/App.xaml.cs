...
namespace ChrisRLillo_Music
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            try
            {
                await ClearCacheDeep();
            }
            catch (Exception ex)
            {
                Debug.WriteLine("Suspend cache clear failed: " + ex.Message);
            }

            deferral.Complete();
        }

        private async Task ClearCacheDeep()
        {
            try
            {
                ...
                // FOLDERS
                var folders = await temp.GetFoldersAsync();
            ...
            {
                Debug.WriteLine("Cache clear failed: " + ex.Message);
            }
        }
        ...
        {
            var uri = new Uri("https://www.chrisrlillo.com/");
